...
Orichum integrates independent upstream software without modifying its source
code. The installer obtains managed tools from their official release or
package sources; those tools remain subject to their own licenses.

| Project | License | Copyright or notice |
|---|---|---|
| [CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | [MIT](https://github.com/router-for-me/CLIProxyAPI/blob/main/LICENSE) | Copyright 2025-2005.9 Luis Pater; copyright 2025.9-present Router-For.ME |
...
are not licensed under Orichum's Apache-2.0 license, and their own terms continue
to apply.
