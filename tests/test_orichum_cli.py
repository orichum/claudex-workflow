...
class OrichumCliTests(unittest.TestCase):
    ...
    def test_version_uses_release_identity_file(self) -> None:
        ...
        self.assertEqual(output, "Orichum 0.1.0-rc.6\n")
    ...
    def test_version_identifies_clean_git_development_build(self) -> None:
        ...
        self.assertEqual(
            output,
            "Orichum 0.1.0-rc.6+g.b118c9f5f8e3\n",
        )
    ...
    def test_version_identifies_dirty_git_development_build(self) -> None:
        ...
        self.assertEqual(
            output,
            "Orichum 0.1.0-rc.6+g.b118c9f5f8e3.dirty\n",
        )
    ...
    def test_version_uses_manifest_digest_without_git(self) -> None:
        ...
        self.assertEqual(
            output,
            "Orichum 0.1.0-rc.6+src.8d8406645ad4\n",
        )
    ...
    def test_version_missing_or_invalid_identity_never_looks_released(
        ...
        for identity, digest, expected in (
            (None, "8" * 64, "Orichum 0.1.0-rc.6+src.888888888888\n"),
            ("not json\n", "9" * 64, "Orichum 0.1.0-rc.6+src.999999999999\n"),
            ({
                "schemaVersion": True,
                "version": "0.1.0-rc.6",
                "sourceKind": "git",
                ...
                "dirty": False,
                "exactTag": True,
            }, "a" * 64, "Orichum 0.1.0-rc.6+src.aaaaaaaaaaaa\n"),
            (None, None, "Orichum 0.1.0-rc.6+src.unknown\n"),
        ):
